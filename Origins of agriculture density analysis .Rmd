...
7. [Setup final figure](#setup-final-figure)
8. [Map for final figure](#map-for-final-figure)
9. [Trend through time panel for final figure](#trend-through-time-panel)
10. [Assemble and print final figure](#assemble-the-figure)
...
#### GAM model with different degrees of freedom
...
names(global.gams) <- paste(names(per.origin), "GAMs")
